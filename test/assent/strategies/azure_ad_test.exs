defmodule Assent.Strategy.AzureADTest do
  ...
  test "callback/2", %{config: config, callback_params: params, bypass: bypass} do
    ...
    config        = Keyword.merge(config, openid_configuration: openid_config, tenant_id: "9188040d-6c67-4c5b-b112-36a304b66dad", client_id: "6cb04018-a3f5-46a7-b995-940c78f5aef3", nonce: "123523")
